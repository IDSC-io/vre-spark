...
* **Hadoop cluster installation of current model** to enable recurring execution of the model
...
* **Transformation to Neo4J-compatible Format** to allow for large-scale network analysis
  Deliverables: Prepared Neo4J format transformer
* **Visualization of Network in Neo4J** in order to give an overview of the interaction graph
...
* **Definition and implementation of initial algorithms/metrics of network analysis** 
...
* **Additional visualizations for VRE Task Force**
  Deliverables: Screening-Results and Hotspots over Time, Eigenvalue Centrality and Comparisons
...
- Estimated Effort: **ETL**: 5 man days, **DS**: 20 man days, **SW-DEV**: 10 man days
- Deadline: End of December, 2019
- Deliverables:
...
- DS-Team
  ...
  - [2019.08 - current] **Benjamin Ellenberger**, Data Scientist (Lead); **Stefan Zahnd**, Data Scientist (Buddy)
...
- **Andrew Atkinson** (andrew.atkinson@insel.ch)
- **Jonas Marschall** (jonas.marschall@insel.ch)
- **Luisa Paola Salazar Vizcaya** (luisapaola.salazarvizcaya@insel.ch)
- **Yvonne Schmiedel** (yvonne.schmiedel@insel.ch)
- **Vanja Piezzi** (vanja.piezzi@insel.ch)
- **Chris Debatin**, IFIK (c.debatin@outlook.de)
- Adriano Pagano (adriano@sqooba.io), Theus Hossmann (theus@sqooba.io), Sqooba
